...
```{r}
# OR.dev <- cbind(OddsRatio = exp(model2int$coef), exp(confint(model2int)))
# OR.speech <- cbind(OddsRatio = exp(model3int$coef), exp(confint(model3int)))
# OR.either <- cbind(OddsRatio = exp(model1int$coef), exp(confint(model1int)))
