...
Create new design object subsetting by age less than 6.
...
## 1 asymptotic 4637 8945 0.5184 0.508 0.5287
```
...
```r
confint(svymean(~srage.p, rchis05))
```
...
```
## 
##  491 values imputed to 3.35
```

```
##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
##    0.91    3.03    3.35    3.35    3.69    4.99
```
...
```r
confint(svymean(~brthwk.p.i, rchis05))
```
...
```r
confint(svymean(~peds, rchis05, na.rm = T))
```
...
```
##       method    x    n   mean  lower  upper
## 1 asymptotic 3062 8945 0.3423 0.3325 0.3521
```
...
```r
confint(svymean(~srh.a.i, rchis05))
```
...
## method factor,1 factor,1 factor,1 factor,1        
## x      4223     2433     1330     319             
## n      8945     8945     8945     8945            
## mean   0.4721   0.272    0.1487   0.03566         
## lower  0.4618   0.2628   0.1413   0.03182         
## upper  0.4825   0.2812   0.1561   0.03951         
##        PI/OTHER SINGLE/MULTIPLE RACE
## method factor,1                     
## x      640                          
## n      8945                         
...
```r
confint(svymean(~racehp2p, rchis05))
```
...
```
##       method   x    n    mean  lower   upper
## 1 asymptotic 614 8945 0.06864 0.0634 0.07388
```
...
```r
confint(svymean(~unins.ever, rchis05))
```
...
```
##       method    x    n   mean  lower  upper
## 1 asymptotic 1653 8945 0.1848 0.1768 0.1928
```
...
```r
confint(svymean(~belowpovl, rchis05))
```
...
```
##       method   x    n  mean  lower  upper
## 1 asymptotic 964 8453 0.114 0.1073 0.1208
```
...
```r
confint(svymean(~cf46, rchis05, na.rm = T))
```
...
```
##       method    x    n  mean  lower  upper
## 1 asymptotic 1496 8453 0.177 0.1688 0.1851
```
...
```r
confint(svymean(~cf47, rchis05, na.rm = T))
```
...
```
##       method    x    n   mean  lower  upper
## 1 asymptotic 1892 8453 0.2238 0.2149 0.2327
```
...
```r
svymean(~referred, rchis05, na.rm = T)
```
...
```r
confint(svymean(~referred, rchis05, na.rm = T))
```
...
## 
## data:  svychisq(~male + cf46, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~male + cf47, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~male + referred, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~racehp2p + cf46, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~racehp2p + cf47, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~racehp2p + referred, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~srh.a.i + cf46, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~srh.a.i + cf47, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~srh.a.i + referred, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~belowpovl + cf46, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~belowpovl + cf47, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~belowpovl + referred, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~unins.ever + cf46, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~unins.ever + cf47, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~unins.ever + referred, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~pedsHiRisk + cf46, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~pedsHiRisk + cf47, rchis05, statistic = "Chisq")
...
## 	Pearson's X^2: Rao & Scott adjustment
## 
## data:  svychisq(~pedsHiRisk + referred, rchis05, statistic = "Chisq")
...
## 
## Call:
## svyglm(formula = cf46 ~ male, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
## Coefficients:
...
## 
## Call:
## svyglm(formula = cf47 ~ male, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ male, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf46 ~ srage.p, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf47 ~ srage.p, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ srage.p, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf46 ~ brthwk.p.i, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf47 ~ brthwk.p.i, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ brthwk.p.i, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf46 ~ racehp2p, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf47 ~ racehp2p, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ racehp2p, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf46 ~ srh.a.i, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf47 ~ srh.a.i, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ srh.a.i, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf46 ~ belowpovl, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf47 ~ belowpovl, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ belowpovl, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf46 ~ unins.ever, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf47 ~ unins.ever, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ unins.ever, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf46 ~ pedsHiRisk, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = cf47 ~ pedsHiRisk, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
## 
## Call:
## svyglm(formula = referred ~ pedsHiRisk, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
##     unins.ever + racehp2p + srh.a.i + brthwk.p.i, design = rchis05, 
...
##     srage.p + pedsHiRisk * brthwk.p.i, design = rchis05, family = quasibinomial)
## 
## Survey design:
## subset(rchis, srage.p < 6)
## 
...
```r
by.age.all <- svyby(~referred, by = ~srage.p + pedsHiRisk, FUN = svymean, design = rchis05, 
    na.rm = T)
by.age.devo <- svyby(~cf46, by = ~srage.p + pedsHiRisk, FUN = svymean, design = rchis05, 
    na.rm = T)
by.age.speech <- svyby(~cf47, by = ~srage.p + pedsHiRisk, FUN = svymean, design = rchis05, 
    na.rm = T)
...
```
## [1] 1.73 4.34 3.23 3.74 3.03 4.17
```
...
rchis05 <- svrepdesign(chis[, -(212 + (1:80))], repweights = chis[, (212 + (1:80))], 
...
```r
by.lbw.all <- svyby(~referred, ~pedsHiRisk + bw.cut, FUN = svymean, design = rchis05, 
    na.rm = T)
by.lbw.devo <- svyby(~cf46, ~pedsHiRisk + bw.cut, FUN = svymean, design = rchis05, 
    na.rm = T)
by.lbw.speech <- svyby(~cf47, ~pedsHiRisk + bw.cut, FUN = svymean, design = rchis05, 
    na.rm = T)
